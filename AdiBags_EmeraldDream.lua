...
function dreamFilter:OnInitialize()
    self.dream = {
        ...
        [210049] = true, -- The Legend of Elun'Ahir
        ...
        [210951] = true, -- Treacherous Research Notes
        [210952] = true, -- Spare Heated Hearthstone
        [210957] = true, -- Rune of the Fire Druids
        [210958] = true, -- Crown of the Dryad Daughter
        [210969] = true, -- Salatrancer
        [210996] = true, -- Moonberry's Many Mischief Makers
        [210997] = true, -- Spare Party Hat
        [211369] = true, -- Charred Staff of the Overseer
        [211371] = true, -- Dryad-Keeper Credentials
